...
#create the plot2 and save it to a png file in the working directory
png(file="plot2.png",width=480,height=480)
plot(feb$dateTime,feb$Global_active_power,xlab="",ylab = "Global Active Power (kilowatts)",pch="")
